...
describe('comms request handler', () => {
  ...
  test('should call runWithCorrelationId with message id when correlationId is empty string', async () => {
    const messageWithEmptyCorrelationId = {
      ...sqsMessage,
      Body: JSON.stringify({
        id: '79389915-7275-457a-b8ca-8bf206b2e67b',
        source: 'source-system',
    ...
    await handleCommRequestMessages([messageWithEmptyCorrelationId])
  ...
  test('should call runWithCorrelationId with message id when correlationId is null', async () => {
    const messageWithNullCorrelationId = {
      ...sqsMessage,
      Body: JSON.stringify({
        id: '79389915-7275-457a-b8ca-8bf206b2e67b',
        source: 'source-system',
    ...
    await handleCommRequestMessages([messageWithNullCorrelationId])
